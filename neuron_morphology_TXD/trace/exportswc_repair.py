...
#      <Command>PythonXT::ExportSWC_repair(#i)</Command>
#    </Item>
#  </Menu>
# </CustomTools>
...
def ExportSWC_repair(aImarisId):
    ...
    for vFilamentIndex in range(vCount):
        ...
        while queue:
            ...
            swc[head] = [head+1, vFilamentsTypes[cur], vFilamentsXYZ[cur], vFilamentsRadius[cur], prev]
